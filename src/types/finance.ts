...
export const POPULAR_CROPS: CropOption[] = [
  { id: 'red_banana', name: 'Red Banana (Sevvaazhai)', nameTa: 'செவ்வாழை (Red Banana)' },
  { id: 'banana', name: 'Banana / Plantain (Poovan/G9)', nameTa: 'வாழை (Banana/G9)' },
  { id: 'turmeric', name: 'Turmeric (Erode Local / BSR)', nameTa: 'மஞ்சள் (Turmeric)' },
  { id: 'onion', name: 'Small Onion / Shallots', nameTa: 'சின்ன வெங்காயம் (Shallots/Onion)' },
  { id: 'paddy', name: 'Paddy / Rice (Ponni/CO51)', nameTa: 'நெல் (Paddy / Rice)' },
  { id: 'coconut', name: 'Coconut Grove', nameTa: 'தென்னை (Coconut)' },
  { id: 'sugarcane', name: 'Sugarcane', nameTa: 'கரும்பு (Sugarcane)' },
  { id: 'maize', name: 'Maize / Corn', nameTa: 'மக்காச்சோளம் (Maize)' },
  { id: 'tapioca', name: 'Tapioca / Cassava', nameTa: 'மரவள்ளிக்கிழங்கு (Tapioca)' },
  { id: 'cotton', name: 'Cotton', nameTa: 'பருத்தி (Cotton)' },
  { id: 'groundnut', name: 'Groundnut / Peanut', nameTa: 'நிலக்கடலை (Groundnut)' },
  { id: 'pulses', name: 'Black Gram / Pulses', nameTa: 'உளுந்து / பயறு (Black Gram)' },
  { id: 'greengram', name: 'Green Gram / Moong Dal', nameTa: 'பாசிப்பயறு (Green Gram)' },
  { id: 'redgram', name: 'Red Gram / Toor Dal', nameTa: 'துவரை (Red Gram / Toor)' },
  { id: 'vegetables', name: 'Vegetables & Chillies', nameTa: 'காய்கறி / மிளகாய் (Veg & Chilli)' },
  { id: 'tomato', name: 'Tomato', nameTa: 'தக்காளி (Tomato)' },
  { id: 'brinjal', name: 'Brinjal / Eggplant', nameTa: 'கத்தரிக்காய் (Brinjal)' },
  { id: 'bhendi', name: 'Ladies Finger / Okra', nameTa: 'வெண்டைக்காய் (Ladies Finger)' },
  { id: 'flowers', name: 'Flowers (Jasmine / Marigold)', nameTa: 'மல்லிகை / பூக்கள் (Flowers)' },
  { id: 'sesame', name: 'Sesame / Gingelly', nameTa: 'எள்ளு (Sesame)' },
  { id: 'millets', name: 'Millets (Ragi / Kambu / Thinai)', nameTa: 'கேழ்வரகு / கம்பு (Ragi/Millet)' },
  { id: 'mango', name: 'Mango / Guava Orchard', nameTa: 'மாந்தோப்பு / கொய்யா (Orchard)' },
  { id: 'guava', name: 'Guava Fruit Orchard', nameTa: 'கொய்யா தோப்பு (Guava)' },
  { id: 'papaya', name: 'Papaya', nameTa: 'பப்பாளி (Papaya)' },
  { id: 'moringa', name: 'Moringa / Drumstick', nameTa: 'முருங்கை (Drumstick)' },
  { id: 'curryleaves', name: 'Curry Leaves', nameTa: 'கறிவேப்பிலை (Curry Leaves)' },
  { id: 'betel', name: 'Betel Leaves', nameTa: 'வெற்றிலைக்கொடி (Betel)' },
  { id: 'fodder', name: 'Green Fodder / Grass (CO4/CO5)', nameTa: 'தீவனப்புல் (Fodder Grass)' },
  { id: 'ginger', name: 'Ginger / Garlic', nameTa: 'இஞ்சி / பூண்டு (Ginger/Garlic)' },
  { id: 'fallow', name: 'Fallow / Resting Land', nameTa: 'தரிசு / ஓய்வு நிலம் (Fallow)' },
];
...
export const POPULAR_TREES: TreeOption[] = [
  { id: 'coconut', name: 'Coconut Tree', nameTa: 'தென்னை மரம் (Coconut)', icon: '🥥', defaultHarvestIntervalMonths: 3 },
  { id: 'teak', name: 'Teak Wood', nameTa: 'தேக்கு மரம் (Teak)', icon: '🪵' },
  { id: 'mango', name: 'Mango Tree', nameTa: 'மா மரம் (Mango)', icon: '🥭', defaultHarvestIntervalMonths: 12 },
  { id: 'neem', name: 'Neem Tree', nameTa: 'வேப்ப மரம் (Neem)', icon: '🌿' },
  { id: 'guava', name: 'Guava Tree', nameTa: 'கொய்யா மரம் (Guava)', icon: '🍈', defaultHarvestIntervalMonths: 6 },
  { id: 'lemon', name: 'Lemon / Lime', nameTa: 'எலுமிச்சை (Lemon)', icon: '🍋', defaultHarvestIntervalMonths: 4 },
  { id: 'moringa', name: 'Moringa Tree', nameTa: 'முருங்கை மரம் (Moringa)', icon: '🌱', defaultHarvestIntervalMonths: 4 },
  { id: 'banana', name: 'Banana Tree', nameTa: 'வாழை மரம் (Banana)', icon: '🍌' },
  { id: 'jackfruit', name: 'Jackfruit Tree', nameTa: 'பலா மரம் (Jackfruit)', icon: '🍈', defaultHarvestIntervalMonths: 12 },
  { id: 'sapota', name: 'Sapota / Chikoo', nameTa: 'சப்போட்டா (Sapota)', icon: '🥔', defaultHarvestIntervalMonths: 6 },
  { id: 'silveroak', name: 'Silver Oak', nameTa: 'சில்வர் ஓக் (Silver Oak)', icon: '🌲' },
  { id: 'mahogany', name: 'Mahogany', nameTa: 'மஹோகனி (Mahogany)', icon: '🌳' },
  { id: 'redsandal', name: 'Red Sandalwood', nameTa: 'செம்மரம் (Red Sandal)', icon: '🪵' },
  { id: 'bamboo', name: 'Bamboo Cluster', nameTa: 'மூங்கில் (Bamboo)', icon: '🎋' },
  { id: 'other', name: 'Other Tree / Border Tree', nameTa: 'மற்ற மரங்கள் (Other)', icon: '🌳' },
];
